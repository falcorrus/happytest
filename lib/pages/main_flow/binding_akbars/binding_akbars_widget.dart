...
import 'binding_akbars_model.dart';
export 'binding_akbars_model.dart';

class BindingAkbarsWidget extends StatefulWidget {
  const BindingAkbarsWidget({
    Key? key,
    this.nextslug,
    this.nextsort,
    this.slug,
  ...
  @override
  _BindingAkbarsWidgetState createState() => _BindingAkbarsWidgetState();
}

class _BindingAkbarsWidgetState extends State<BindingAkbarsWidget> {
  late BindingAkbarsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BindingAkbarsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'bindingAkbars'});
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model
                                    .textFieldMailControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onDoubleTap: () async {
                              logFirebaseEvent(
                                  'BINDING_AKBARS_Button-more_ON_DOUBLE_TAP');
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'BINDING_AKBARS_PAGE_Button-more_ON_TAP');
